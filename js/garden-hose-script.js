...
function printProductInfo() {
    ...
    printWindow.document.write(`
        <html>
        <head>
            <title>Parama Garden Hose - Product Information</title>
            <style>
        ...
        <body>
            <h1>Parama Garden Hose - Product Information</h1>
...
function requestQuote() {
    ...
    const productName = 'Parama Garden Hose';
    const lengthText = selectedLength === '100' ? '100\'-0"' : '200\'-0"';
