...
function printProductInfo() {
    ...
    printWindow.document.write(`
        <html>
        <head>
            <title>Parama Alkathene - Product Information</title>
            <style>
        ...
        <body>
            <h1>Parama Alkathene - Product Information</h1>
...
function requestQuote() {
    ...
    const productName = 'Parama Alkathene';
    const lengthText = selectedLength === '100' ? '100\'-0"' : '200\'-0"';
